...
<template>
  <div class="flex flex-wrap justify-center max-w-screen-2xl m-auto">
    ...
    <NuxtLink v-for="category in categories" :key="category.id" :to="localePath(`/products?category=${encodeURIComponent(category.name)}`)" class="w-full max-w-[444px] p-3 lg:p-2">
